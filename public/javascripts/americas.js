document.addEventListener('DOMContentLoaded', function () {
    let countries = ['Argentina', 'Mexico', 'Peru', 'Ecuador', 'Uruguay', 'Venezuela', 'Colombia', 'El-Salvador', 'Bolivia', 'Brazil', 'Cuba', 'Suriname', 'Jamaica', 'Chile', 'Guyana', 'Guatemala', 'Costa-Rica', 'Honduras', 'Belize', 'Trinidad-and-Tobago', 'Puerto-Rico', 'Haiti', 'Dominican-Republic', 'Nicaragua', 'Panama', 'Paraguay', 'United-States', 'Canada', 'St-Vincent-and-the-Grenadines', 'Grenada', 'Barbados', 'St-Lucia', 'Dominica', 'St-Kitts-and-Nevis', 'Antigua-and-Barbuda', 'Bahamas'];
