document.addEventListener('DOMContentLoaded', function () {
    let countries = ['Serbia', 'Italy', 'Greece', 'Iceland', 'Portugal', 'Spain', 'Ukraine', 'Russia', 'Cyprus', 'Belarus', 'Poland', 'Lithuania', 'Denmark', 'Norway', 'Sweden', 'Finland', 'Germany', 'Netherlands', 'Czechia', 'Latvia', 'Estonia', 'Slovakia', 'Hungary', 'Moldova', 'Bulgaria', 'France', 'Switzerland', 'Croatia', 'Romania', 'Austria', 'Slovenia', 'Bosnia-and-Herzegovina', 'Montenegro', 'Albania', 'North-Macedonia', 'Kosovo', 'Ireland', 'San-Marino', 'Vatican-City', 'Monaco', 'Andorra', 'Luxembourg', 'Liechtenstein', 'Belgium', 'Malta', 'United-Kingdom'];
