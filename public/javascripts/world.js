...
document.addEventListener('DOMContentLoaded', function () {
    let countries = ['Democratic-Republic-of-the-Congo', 'Tanzania', 'South-Africa', 'Central-African-Republic', 'South-Sudan', 'Nigeria', 'Sudan', 'Libya', 'Guinea-Bissau', 'Ghana', 'Madagascar', 'Cote-d-Ivoire', 'Algeria', 'Cameroon', 'Botswana', 'Kenya', 'Mali', 'Somalia', 'Mozambique', 'Mauritania', 'Morocco', 'Egypt', 'Lesotho', 'Eswatini', 'Angola', 'Zambia', 'Zimbabwe', 'Republic-of-the-Congo', 'Gabon', 'Sao-Tome-and-Principe', 'Uganda', 'Ethiopia', 'Liberia', 'Equatorial-Guinea', 'Rwanda', 'Chad', 'Niger', 'Namibia', 'Burkina-Faso', 'Benin', 'Guinea', 'The-Gambia', 'Senegal', 'Sierra-Leone', 'Togo', 'Malawi', 'Tunisia', 'Burundi', 'Djibouti', 'Eritrea', 'Cabo-Verde', 'Mauritius', 'Comoros', 'Serbia', 'Italy', 'Greece', 'Iceland', 'Portugal', 'Spain', 'Ukraine', 'Russia', 'Cyprus', 'Belarus', 'Poland', 'Lithuania', 'Denmark', 'Norway', 'Sweden', 'Finland', 'Germany', 'Netherlands', 'Czechia', 'Latvia', 'Estonia', 'Slovakia', 'Hungary', 'Moldova', 'Bulgaria', 'France', 'Switzerland', 'Croatia', 'Romania', 'Austria', 'Slovenia', 'Bosnia-and-Herzegovina', 'Montenegro', 'Albania', 'North-Macedonia', 'Kosovo', 'Ireland', 'Monaco', 'Andorra', 'Luxembourg', 'Liechtenstein', 'Belgium', 'Malta', 'United-Kingdom', 'China', 'Iran', 'Saudi-Arabia', 'Türkiye', 'Armenia', 'Afghanistan', 'Israel', 'Sri-Lanka', 'North-Korea', 'Nepal', 'Turkmenistan', 'Taiwan', 'India', 'Kyrgyzstan', 'Iraq', 'Thailand', 'Uzbekistan', 'Kazakhstan', 'Mongolia', 'Jordan', 'Syria', 'Oman', 'Bhutan', 'Tajikistan', 'Pakistan', 'Japan', 'South-Korea', 'Azerbaijan', 'Timor-Leste', 'Cambodia', 'Laos', 'Myanmar', 'Bangladesh', 'Georgia', 'Philippines', 'Bahrain', 'United-Arab-Emirates', 'Qatar', 'Russia', 'Yemen', 'Malaysia', 'Lebanon', 'Kuwait', 'Indonesia', 'Vietnam', 'Singapore', 'Palestine', 'Brunei', 'Argentina', 'Mexico', 'Peru', 'Ecuador', 'Uruguay', 'Venezuela', 'Colombia', 'El-Salvador', 'Bolivia', 'Brazil', 'Cuba', 'Suriname', 'Jamaica', 'Chile', 'Guyana', 'Guatemala', 'Costa-Rica', 'Honduras', 'Belize', 'Trinidad-and-Tobago', 'Puerto-Rico', 'Haiti', 'Dominican-Republic', 'Nicaragua', 'Panama', 'Paraguay', 'United-States', 'Canada', 'St-Vincent-and-the-Grenadines', 'Grenada', 'Barbados', 'St-Lucia', 'Dominica', 'Antigua-and-Barbuda', 'Bahamas', 'Papua-New-Guinea', 'Solomon-Islands', 'Vanuatu', 'Fiji', 'Australia', 'New-Zealand', 'Timor-Leste', 'Indonesia', 'Samoa'];
